SP_mlogit<-function(attribute_type,nalts,nblocks,sets,
  dataset_forms,nrespondents,optout,base=NULL,conf=FALSE,conf_level=NULL,design=NULL,other_attributes=NULL){
  library(choiceDes)
  library(varhandle)
  library(readxl)
  library(mlogit)
